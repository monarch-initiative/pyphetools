...
from ._base import OntologyClass, TimeElement, File
...
class Biosample(MessageMixin):
    ...
    def __init__(
            ...
            # measurements: typing.Optional[typing.Iterable[Measurement]] = None, # TODO: add after implementing Measurement
            ...
            # procedure: typing.Optional[Procedure] = None, # TODO: add after implementing Procedure
        ...
        # self._measurements = [] if measurements is None else list(measurements)  # TODO: add after implementing Measurement
        ...
        # self._procedure = [] if procedure is None else list(procedure)  # TODO: add after implementing Procedure
    ...
    def field_names() -> typing.Iterable[str]:
        return (
            ...
            'pathological_stage', 'pathological_tnm_finding', 'diagnostic_markers',
            # 'procedure',
